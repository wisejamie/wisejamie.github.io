...
export function SectionNav({ simState, activeSectionId, onSelect, containerWidth }: SectionNavProps) {
    ...
    return (
      <div
        style={{
          ...
          gap: 6,
          padding: '10px 12px',
          background: 'linear-gradient(to bottom, rgba(14,26,18,0.92) 70%, transparent)',
          zIndex: 5,
          scrollbarWidth: 'none',
        }}
        ...
        {SECTION_ORDER.map(sectionId => {
          ...
          return (
            <button
              ...
              style={{
                flexShrink: 0,
                background: isActive ? 'rgba(245,166,35,0.15)' : 'rgba(0,0,0,0.55)',
  ...
  return (
    <nav
      style={{
        ...
        zIndex: 5,
        pointerEvents: 'none',
        background: 'linear-gradient(to right, rgba(10,18,12,0.78) 0%, transparent 100%)',
      }}
      onClick={e => e.stopPropagation()}
    >
