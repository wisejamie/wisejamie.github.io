...
export const ABOUT_INFO: AboutInfo = {
  ...
  bio: "Hey, I’m Jamie. I recently graduated from McGill University with a degree in Computer Science. You can find more about my work and experience in the other sections, but the quick version is that I enjoy building things: web apps, models, tools, (campfires), and projects that help me solve difficult problems. I also really like talking through those problems with other people.\n\nTied with problem solving, my favourite activity in the world is throwing. Baseballs, frisbees, tennis balls, footballs, whatever. I love going outside and getting active, with my friends or my dogs. I'm always open to connecting with like-minded people, so feel free to reach out if you want to chat about anything tech-related, or not.",
